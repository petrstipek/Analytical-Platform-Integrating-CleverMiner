...
from cleverminer_tasks.execution.procedures.fourftMiner.mining import FourFtMiningService
from cleverminer_tasks.execution.procedures.sdFourftMiner.mining import Sd4FtMiningService
