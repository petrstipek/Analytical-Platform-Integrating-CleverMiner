    ...
    <Drawer open={open} onOpenChange={onOpenChange} direction="right">
      <DrawerContent className="mt-0 h-full w-[95vw] max-w-[1000px] rounded-none">
        <div className="mx-auto flex h-full w-full flex-col">
          ...
          <div className="m-4 grid gap-4 rounded-lg bg-gray-50 p-4 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-6 pb-6">
                ...
                {column.clm_guidance?.reasons && column.clm_guidance.reasons.length > 0 && (
                  <div className="space-y-2">
                    <h2 className="flex items-center gap-2 text-xl font-semibold text-gray-700">
                      <Brain className="h-6 w-6 text-gray-500" /> Analysis Insights
                    </h2>
              ...
              <PlatformCard>
                <div className="space-y-3">
                  <h2 className="flex items-center gap-2 text-xl font-semibold text-gray-700">
                    <Rotate3d className="h-6 w-6 text-gray-500" /> Available Transformations
                  </h2>
                    ...
                    <section className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {strategies.map((strategy) => (
                          <Button
                            variant={selectedFillStrategy === strategy ? 'default' : 'outline'}
                            key={strategy}
                            size="sm"
                            onClick={() => {
                              setSelectedFillStrategy(strategy);
                      ...
                      {selectedFillStrategy === FillnaStrategiesOptions.constant && (
                  ...
                  <section className={'space-y-3 pt-6'}>
                    <h2 className="flex items-center gap-2 text-xl font-semibold text-gray-700">
                      <BookSearch className="h-6 w-6 text-gray-500" /> Defined Transformations
                    </h2>
                    <div className="space-y-3">
                      {stagedSteps.length === 0 && (
                        <p className="text-xs text-gray-400 italic">
                          No transformations selected yet.
                        </p>
                      )}
          ...
          <DrawerFooter className="mb-4">
            <PlatformCard contentClassName={'w-full'}>
              <p className="text-xs text-gray-400 italic">
                You can continue on defining the preprocessing steps on other columns. Apply All
                button will appear in case of defined preprocessing steps on the page.
              </p>
