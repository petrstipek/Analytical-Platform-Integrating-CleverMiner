...
import { Field, FieldGroup, FieldLabel, FieldSeparator } from '@/shared/components/ui/atoms/field';
import { Input } from '@/shared/components/ui/atoms/input';
import Cubes from '@/shared/components/ui/organisms/animations/Cubes';
    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-muted relative hidden overflow-hidden md:flex">
            <div className="absolute inset-0 grid place-items-center p-10">
              <div className="h-full max-h-[520px] w-full max-w-[520px]">
                <Cubes
                  gridSize={7}
                  maxAngle={60}
                  cubeSize={40}
